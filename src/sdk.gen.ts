 ...
 */
export const rancherClustersSecurityGroupsList = <ThrowOnError extends boolean = false>(options: Options<RancherClustersSecurityGroupsListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<RancherClustersSecurityGroupsListResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
 ...
 */
export const rancherClustersSecurityGroupsRetrieve = <ThrowOnError extends boolean = false>(options: Options<RancherClustersSecurityGroupsRetrieveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<RancherClustersSecurityGroupsRetrieveResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
